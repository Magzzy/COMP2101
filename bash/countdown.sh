...
# Task: Explain in a comment how the line with the word moose in it works. It sends an error message
# to stderr (or the screen). It is currently setup to only send the first part of the message.
...
#### Functions
function interupts {
  echo "Thanks for interrupting, now I have to start again!"
  sleepCount=$numberOfSleeps+1
}

function quits {
  exit "You found the secret to quit! Exiting!"
}
